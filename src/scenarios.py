...
_SCENARIOS: Dict[str, Tuple[List[Cone], CarPose]] = {
    ...
    "21": (
        [
            Cone(x=2.0, y=3.0, color=1), # Blue
            Cone(x=3.0, y=4.0, color=1), # Blue
            Cone(x=4.0, y=3.0, color=1), # Blue
        ],
        CarPose(x=0.0, y=0.0, yaw=1.0),
    ),
    ...
    "22": (
        [
            Cone(x=3.0, y=2.0, color=0), # Yellow
            Cone(x=4.0, y=1.0, color=0), # Yellow
            Cone(x=5.0, y=2.0, color=0), # Yellow
        ],
        CarPose(x=0.0, y=0.0, yaw=0.8),
    ),
}
